            ...
            @if(request('plant_id') == 'all' || request('plant_id') == $plant->id_whlocs)
                ...
                <div>
                    ...
                    <div class="filter-overlay" id="filter-3">
                        <p>Part ID:</p><input type="text" placeholder="Input.." onkeyup="filterTable(3, this.value)">
                    </div>
                    <div class="filter-overlay" id="filter-4">
                        <p>Quantity:</p><input type="text" placeholder="Input.." onkeyup="filterTable(4, this.value)">
                    </div>
                    <div class="filter-overlay" id="filter-5">
                        <p>(Transfer) From ID:</p><input type="text" placeholder="Input.." onkeyup="filterTable(5, this.value)">
                    </div>
                    <div class="filter-overlay" id="filter-6">
                        <p>(Transfer) To ID:</p><input type="text" placeholder="Input.." onkeyup="filterTable(6, this.value)">
                    </div>
                    <div class="filter-overlay" id="filter-7">
                        <p>Part Usage:</p><input type="text" placeholder="Input.." onkeyup="filterTable(7, this.value)">
                    </div>
                    <div class="filter-overlay" id="filter-8">
                        <p>PIC Warehouse:</p><input type="text" placeholder="Input.." onkeyup="filterTable(8, this.value)">
                    </div>
                    <div class="filter-overlay" id="filter-9">
                        <p>PIC Request:</p><input type="text" placeholder="Input.." onkeyup="filterTable(9, this.value)">
                    </div>
                    <div class="filter-overlay" id="filter-10">
                        <p>Price:</p><input type="text" placeholder="Input.." onkeyup="filterTable(10, this.value)">
                    </div>
                    <div class="filter-overlay" id="filter-11">
                        <p>Supplier:</p><input type="text" placeholder="Input.." onkeyup="filterTable(11, this.value)">
                    </div>
                    <div class="filter-overlay" id="filter-12">
                        <p>Date Inbound:</p><input type="text" placeholder="Input.." onkeyup="filterTable(12, this.value)">
                    </div>
